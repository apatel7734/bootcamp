...
public class TimeLineMainActivity extends FragmentActivity implements TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Tab homeTab = actionBar.newTab().setTag("HomeTimeLine").setText("Home").setTabListener(this);
		Tab mentionTab = actionBar.newTab().setTag("MentionTimeLine").setText("Mention").setTabListener(this);
